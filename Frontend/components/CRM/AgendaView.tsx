...
import { Calendar as CalendarIcon, ChevronLeft, ChevronRight, Clock, User, RefreshCw, CalendarCheck, CalendarDays, Plus, Loader2, AlertTriangle, Pencil, Eye, Trash2, X as XIcon, Phone } from 'lucide-react'
                                            ...
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <div className="flex items-center gap-2 mt-1">
                                                        <a href={`tel:${selectedAppointment.client_phone?.replace(/[^\d+]/g, '')}`}
                                                            className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-emerald-500/15 border border-emerald-500/25 text-emerald-400 text-[11px] font-bold hover:bg-emerald-500/25 transition-colors"
                                                            onClick={e => e.stopPropagation()}>
                                                            <Phone size={11} />
                                                            {selectedAppointment.client_phone}
                                                        </a>
                                                        <a href={`https://wa.me/${selectedAppointment.client_phone?.replace(/[^\d]/g, '')}`}
                                                            target="_blank" rel="noopener noreferrer"
                                                            className="w-7 h-7 flex items-center justify-center rounded-lg bg-[#25D366]/15 border border-[#25D366]/25 text-[#25D366] hover:bg-[#25D366]/25 transition-colors"
                                                            onClick={e => e.stopPropagation()}>
